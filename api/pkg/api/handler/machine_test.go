...
func TestMachineHandler_Update(t *testing.T) {
	...
	tsc.Mock.On("ExecuteWorkflow", mock.Anything, mock.AnythingOfType("internal.StartWorkflowOptions"), "ApplyMachineHealthReportOverride", mock.Anything).Return(wrun, nil)
	tsc.Mock.On("ExecuteWorkflow", mock.Anything, mock.AnythingOfType("internal.StartWorkflowOptions"), "ClearMachineHealthReportOverride", mock.Anything).Return(wrun, nil)
	...
	tsc1.Mock.On("ExecuteWorkflow", mock.Anything, mock.AnythingOfType("internal.StartWorkflowOptions"), "ApplyMachineHealthReportOverride", mock.Anything).Return(wruntimeout, nil)
	tsc1.Mock.On("ExecuteWorkflow", mock.Anything, mock.AnythingOfType("internal.StartWorkflowOptions"), "ClearMachineHealthReportOverride", mock.Anything).Return(wruntimeout, nil)
